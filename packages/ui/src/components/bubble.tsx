...
const bubbleVariants = cva(
	"group/bubble relative flex w-fit min-w-0 max-w-[88%] flex-col gap-1 data-[variant=ghost]:max-w-full data-[align=end]:self-end group-data-[align=end]/message:self-end sm:max-w-[80%]",
	{
		variants: {
			variant: {
				default:
