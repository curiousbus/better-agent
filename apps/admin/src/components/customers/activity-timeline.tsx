// apps/admin/src/components/customers/activity-timeline.tsx
...
const ICON_MAP: Record<ActivityType, ReactNode> = {
	...
	account_blocked: <BanIcon className="size-4" />,
	account_unblocked: <ShieldCheckIcon className="size-4" />,
};
...
export function ActivityTimeline({ userId }: { userId: string }) {
	const query = useQuery(
		orpc.admin.customerActivity.queryOptions({ input: { userId } })
	);
